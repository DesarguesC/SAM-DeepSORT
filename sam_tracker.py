...
flags.DEFINE_string('sam_path', './checkpoints/sam_vit_h_4b8939.pth', 'path to sam model')
flags.DEFINE_string('sam_type', 'vit_h', 'model type of sam')
...
def main(_argv):
    ...
    # usage: masks = mask_generator.generate(cv2 image - <np.array>)
    print('HERE')
